...
class  NeuralAgent():
    ...
    def _init_run(self):
        ...
        self.weights = np.ones((3,self.n_neurons,self.n_neurons)) # 3 because 3 outputs
        self.weights_multiplex = np.ones((3,self.n_neurons,self.n_neurons)) # to avoid moving target within the run
